...
BEGIN
	...
	ORDER BY 
		...
		CASE 
			WHEN @campoOrdenar = 'FechaLanzamiento' AND @ordenAscendente = 'True' THEN Titulo END ASC,
		CASE
			WHEN @campoOrdenar = 'FechaLanzamiento' AND @ordenAscendente = 'False' THEN Titulo END DESC 
